...
//Create person object
		...
		//personList.stream().map(Person::getDeptno).distinct().forEach(System.out::println);
		//no.2:: Count of person  from each department
		/*Map<String,Long> listMap=personList.stream().collect(Collectors.groupingBy(Person::getDeptno, Collectors.counting()));
